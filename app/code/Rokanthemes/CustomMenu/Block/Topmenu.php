    ...
    public function getCustomMenuHtml()
    {
        ...
        foreach($categories as $category) {
            ...
            if(!$rt_menu_hide_item) {
                ...
                $rt_menu_icon_img = $cat_model->getData('rt_menu_icon_img');
				/**
				 * 2019-12-28 Dmitry Fedyuk https://github.com/mage2pro
				 * 1) "The «Brands» menu item is shown wrongly on the royalwholesalecandy.com website":
				 * https://github.com/royalwholesalecandy/core/issues/89
				 * 2) "«The file "pub/media/catalog/tmp/category/false" doesn't exist or not a file»":
				 * https://github.com/royalwholesalecandy/core/issues/86
				 */
                if ('false' === $rt_menu_icon_img) {
                	$rt_menu_icon_img = null;
				}
                $rt_menu_font_icon = $cat_model->getData('rt_menu_font_icon');
                ...
                $catUrl = $this->_categoryHelper->getCategoryUrl($category);
                if($category->getId() == '5'){
                    $catUrl = '/brands';
                }
                if($category->getId() == '6'){
                ...
                $html .= '<a href="'.$catUrl.'" class="level-top">';
                if ($rt_menu_icon_img)
