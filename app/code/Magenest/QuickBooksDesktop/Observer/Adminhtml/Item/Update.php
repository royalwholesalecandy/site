    ...
    public function execute(Observer $observer)
    {
        ...
        if (strpos($redirectUrl, 'qbdesktop/price/update') === false
            ...
            if ($productId) {
                ...
                $productData = (array)$this->_request->getPost();
                //if(isset($productData['product']['quantity_and_stock_status']['qty']) && isset($productData['product']['stock_data']['qty']) && $productData['product']['stock_data']['qty'] != $productData['product']['quantity_and_stock_status']['qty']){
                    //$this->_queueHelper->createQueue($productId, 'InventoryAdjustmentAdd', 'ProductInv', Operation::OPERATION_ADD, Priority::PRIORITY_PRODUCT);
                //}
            }
        }
    }
