...
class Config
{
    ...
    protected function _getReplacements($appName)
    {
        ...
        }elseif ($appName == "Mapping Inventory") {
            $appUrl = $url . 'qbdesktop/connection_inventory/sync';
        }elseif ($appName == "Update Orders") {
            $appUrl = $url . 'qbdesktop/connection_orderprocessing/sync';
        }
