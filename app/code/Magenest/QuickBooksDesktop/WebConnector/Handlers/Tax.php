            ...
            if (isset($result[$action])) {
                if (isset($result['ItemSalesTaxRet']['ListID'])) {
                    ...
                    foreach ($result[$action] as $child) {
                        ...
                        \Magento\Framework\App\ObjectManager::getInstance()->get('Psr\Log\LoggerInterface')->debug('Code ' . $taxcode);
                        \Magento\Framework\App\ObjectManager::getInstance()->get('Psr\Log\LoggerInterface')->debug('DATATAX ' . $dataTax);
                        $this->saveTax($dataTax);
                    }
                }
            }
