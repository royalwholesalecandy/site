...
class Router implements RouterInterface
{
    ...
    /**
     * @var \Mageplaza\DailyDeal\Block\Pages\AllDeals
     */
    protected $_allDeals;

    /**
     * @var \Mageplaza\DailyDeal\Block\Pages\NewDeals
     */
    protected $_newDeals;

    /**
     * @var \Mageplaza\DailyDeal\Block\Pages\BestsellerDeals
     */
    protected $_sellerDeals;

    /**
     * @var \Mageplaza\DailyDeal\Block\Pages\FeaturedDeals
     */
    ...
    public function match(RequestInterface $request)
    {
        ...
        if (!$this->_helperData->isEnabled() || (sizeof($routePath) != 1)) {
            return null;
        }
