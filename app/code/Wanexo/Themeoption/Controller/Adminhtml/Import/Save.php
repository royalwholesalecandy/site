<?php
namespace Wanexo\Themeoption\Controller\Adminhtml\Import;
...
class Save extends \Magento\Backend\App\Action
{
    ...
    /**
     * @var \Wanexo\Themeoption\Helper\Import
     */
    protected $_wanexoImport;
    ...
    public function __construct(
        ...
        \Wanexo\Themeoption\Helper\Import $wanexoImport,
        ...
        $this->_wanexoImport = $wanexoImport;
    }
                ...
                foreach ($importData as $_module) {
                    if(isset($_module['tables'])){
                        ...
                        foreach ($tables as $tablename => $rows) {
                            ...
                            foreach ($rows as $row) {
                                $where = '';
                                $query_data = $this->_wanexoImport->buildQueryImport($row, $table_name, $overwrite, $data['store_id']); 
