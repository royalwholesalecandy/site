...
$img    = new \Itoris\RegFields\Helper\Captcha\Securimage\Securimage;
$img->audio_format = (isset($_GET['format']) && in_array(strtolower($_GET['format']), ['mp3', 'wav']) ? strtolower($_GET['format']) : 'mp3');
